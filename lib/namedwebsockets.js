...
/**** END WEBSOCKET SHIM ****/
	...
	var _NetworkWebSocket = function (serviceName, subprotocols) {
		...
		// New custom attributes on NetworkWebSocket objects
	...
	var NetworkWebSocket = function (serviceName, subprotocols) {
		return new _NetworkWebSocket(serviceName, subprotocols);
	};
